...
<body>
<form method="post" name="multiple_upload_form" id="multiple_upload_form" enctype="multipart/form-data" action="<?php base_url()?>/imageupload/index.php/ImageController/do_upload">
...
<div id="images_preview"><img src="<?php echo($url = base_url().'uploads/'.$full_path);?>"</div>   
