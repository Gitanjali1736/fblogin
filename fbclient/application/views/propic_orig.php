...
<body>
<?php echo form_open_multipart('ctrl_client/do_upload');?>
<div class= "container-fluid">
		<div class= "row header" >
           ...
           <div class="col-sm-4 ">
                ...
                <a href="#" data-toggle="tooltip" data-placement="bottom" title="Friend Requests"><i class="glyphicon glyphicon-user" style="color:white"></i></a>
        ...
        <div class="col-sm-2 col-xs-offset-3">
            ...
            <a href="#" <span class = "glyphicon glyphicon-camera" style="color:white"></span><span class="label label-default"><button id="myBtn">Update profile picture</button></span></a>
  ...
  <div class="modal-content">
   ...
   <form method="post" name="multiple_upload_form" id="multiple_upload_form" enctype="multipart/form-data" action="index.php/ImageController/do_upload">
